...
import { Coins, Package, Sprout, TrendingUp, RefreshCw } from 'lucide-react'
...
function StatsGrid() {
  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      ...
      <StatCard icon={Sprout} label="Farming Actif" value={String(staked.length)} iconColor="#22c55e" />
